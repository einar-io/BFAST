\begin{abstract}
    ...
    \noindent Second we validate our translation by leveraging the Futhark
    test framework.

    \noindent Third we apply optimizations to improve both temporal
    ...
    \noindent Finally we provide benchmarks for our optimizations
    including when regressions occured.
